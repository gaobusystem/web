...
const form = useForm({
    ...
    product_id1 : props.order.product_id1,
    product_id2 : props.order.product_id2,
    product_id3 : props.order.product_id3,
    num1 : String(props.order.num1),
    num2 : String(props.order.num2),
    num3 : String(props.order.num3),
    search_product_name: ''
});
//商品選択時の処理
...
const handleSubmit = () => {
    ...
    //});
    if (!form.product_id2) {
        form.product_id2 = null;
        form.num2 = null;
    }
    if (!form.product_id3) {
        form.product_id3 = null;
        form.num3 = null;
    }
    form.patch(route('orders.update',props.order), {
...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">オーダー更新</h2>
        </template>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mt-4 flex">
                    ...
                    <div v-if="selectedProduct1" class="flex">
                        <div class="ml-10 w-24">
                            ...
                            <div class="mt-3 ml-2 font-medium text-xl">{{ selectedProduct1.code }}</div>
                        </div>
                        <div class="ml-10 w-24">
                            <InputLabel value="価格" />
                    ...
                    <div v-else="selectedProduct1" class="ml-5 mt-7">
                        <PrimaryButton @click="confirmUserDeletion(1)" class="px-4 py-2 bg-gray-400 text-white border rounded-md font-semibold text-xs">
                            検索
                        </PrimaryButton>
                    </div>
                </div>
                ...
                <div class="mt-4 flex">
                    ...
                    <div v-if="selectedProduct2" class="flex">
                        <div class="ml-10 w-24">
                            <InputLabel value="コード" />
                            <div class="mt-3 ml-2 font-medium text-xl">{{ selectedProduct2.code }}</div>
                        </div>
                        <div class="ml-10 w-24">
                            <InputLabel value="価格" />
                    ...
                    <div v-else="selectedProduct1" class="ml-5 mt-7">
                        <PrimaryButton @click="confirmUserDeletion(2)" class="px-4 py-2 bg-gray-400 text-white border rounded-md font-semibold text-xs">
                            検索
                        </PrimaryButton>
                    </div>
                </div>
                ...
                <div class="mt-4 flex">
                    ...
                    <div v-if="selectedProduct3" class="flex">
                        <div class="ml-10 w-24">
                            <InputLabel value="コード" />
                            <div class="mt-3 ml-2 font-medium text-xl">{{ selectedProduct3.code }}</div>
                        </div>
                        <div class="ml-10 w-24">
                            <InputLabel value="価格" />
                    ...
                    <div v-else="selectedProduct1" class="ml-5 mt-7">
                        <PrimaryButton @click="confirmUserDeletion(3)" class="px-4 py-2 bg-gray-400 text-white border rounded-md font-semibold text-xs">
                            検索
                        </PrimaryButton>
                    </div>
                </div>
