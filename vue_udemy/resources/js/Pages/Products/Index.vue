    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            ...
            <div class="mt-3 mb-3 ml-3 flex">
                ...
                <span v-if="props.products.data.length===0" class="m-2">該当する商品はありません。</span>
            </div>
        ...
        <div class="flex items-center gap-x-1">
            <div v-for="(link,index) in products.links">
                <div v-if="index==0">
                    <Link :href="route('products.index', { page: products.current_page-1, search_str: form.search_str })"
                ...
                <div v-else-if="index==products.last_page+1">
                    <Link :href="route('products.index', { page: products.current_page+1, search_str: form.search_str })"
                    v-show="link['url']!=null"
                    type="button"
                    class="min-h-[38px] min-w-[38px] flex justify-center items-center text-gray-800 hover:bg-gray-100 py-2 px-3 text-sm rounded-lg focus:outline-none focus:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:text-white dark:hover:bg-white/10 dark:focus:bg-white/10"
                ...
                <div v-else>
                    <Link :href="route('products.index', { page: link['label'], search_str: form.search_str })"
